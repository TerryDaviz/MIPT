...
<body>
<div class="session">
<form method="post" action="${pageContext.request.contextPath}/Sign-In-Servlet" class="log-in" autocomplete="off">
    <h4>Вход</h4>
    <p>${ServletResponse}.</p>
    ...
    <a href="signUpForm.jsp" class="discrete" target="_self">Зарегистрироваться</a>
</form>
</div>
</body>
</html>
