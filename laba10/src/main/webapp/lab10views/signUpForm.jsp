...
<body>
    <div class="session">
    <form method="post" action="${pageContext.request.contextPath}/Register-Servlet" class="log-in" autocomplete="off">
        <h4>Регистрация</h4>
        <p>${ServletResponse}.</p>
        ...
        <a href="signInForm.jsp" class="discrete" target="_self">Войти</a>
    </form>
    </div>
</body>
</html>